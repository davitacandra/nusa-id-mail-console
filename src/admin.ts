...
export const addAdmin = async (req: Request, res: Response): Promise<Response> => {
    ...
    try {
        ...
        const [insertResult] = await connection.promise().execute(insertQuery, [ username, hashedPassword, fullname, type, companyId
        ])
...
export const deleteAdmin = async (req: Request, res: Response): Promise<Response> => {
    ...
    try {
        ...
        const [deleteResult] = await connection.promise().execute<OkPacket>(deleteQuery, [adminId])
...
export const showAdmin = async (req: Request, res: Response): Promise<Response> => {
    ...
    try {
        const [admins] = await connection.promise().query<RowDataPacket[]>(query, queryParams)
...
export const manageAdmin = async (req: Request, res: Response): Promise<Response> => {
    ...
    try {
        ...
        const [updateResult] = await connection.promise().execute<OkPacket>(updateQuery, updateParams)
