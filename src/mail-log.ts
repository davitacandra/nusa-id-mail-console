...
export const showEmailLog = async (req: Request, res: Response): Promise<Response> => {
    ...
    try {
        ...
        const [emailLogs] = await connection.promise().execute<RowDataPacket[]>(emailLogQuery, [companyId])
