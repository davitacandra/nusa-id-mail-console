...
export const addEmail = async (req: Request, res: Response): Promise<Response> => {
    ...
    try {
        ...
        const [companyAccountLimitResult] = await connection.promise().execute<RowDataPacket[]>(companyAccountLimitQuery, [companyId])
        ...
        const [currentAccountCountResult] = await connection.promise().execute<RowDataPacket[]>(currentAccountCountQuery, [domainId])
        ...
        const [insertResult] = await connection.promise().execute<OkPacket>(insertEmailQuery, [email, hashedPassword, mail_insert_by, domainId])
...
export const deleteEmail = async (req: Request, res: Response): Promise<Response> => {
    ...
    try {
        ...
        const [emailDomainCheckResult] = await connection.promise().execute<RowDataPacket[]>(emailDomainCheckQuery, [emailId, companyId])
        ...
        const [deleteResult] = await connection.promise().execute<OkPacket>(deleteQuery, [emailId])
...
export const showEmail = async (req: Request, res: Response): Promise<Response> => {
    ...
    try {
        ...
        const [emails] = await connection.promise().query<RowDataPacket[]>(query, [companyId])
...
export const resetPassword = async (req: Request, res: Response): Promise<Response> => {
    ...
    try {
        ...
        const [domainCheckResult] = await connection.promise().execute<RowDataPacket[]>(domainCheckQuery, [emailId, companyId])
        ...
        const [updateResult] = await connection.promise().execute<OkPacket>(updateQuery, [hashedPassword, emailId])
...
export const changeEmailStatus = async (req: Request, res: Response): Promise<Response> => {
    const { emailId } = req.params
    const companyId = req.companyId // Provided by attachUserInfo middleware
    ...
    try {
        ...
        const [currentStatusResult] = await connection.promise().execute<RowDataPacket[]>(getStatusQuery, [emailId])
        ...
        const [updateResult] = await connection.promise().execute<OkPacket>(updateQuery, [newStatus, emailId])
